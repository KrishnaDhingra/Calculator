...
let first_select3 = document.getElementById("first_select3")
let second_select3 = document.getElementById("second_select3")
let number2 = document.querySelectorAll(".number2")
let first_output3 = document.getElementById("first_output3")
let second_output3 = document.getElementById("second_output3")
let backspace3 = document.getElementById("backspace3")
let answer = null
let ans = null
let computed  =  false
...
Object.keys(data).forEach(function(key) {
	...
	dropdown2.classList.add('options2')
	...
	first_select3.appendChild(dropdown)
	...
	second_select3.appendChild(dropdown2)
  });
...
let getData = (url, first_currency, second_currency, num) =>{
    fetch(url).then((response) =>{
        return response.json()
    }).then((data)=>{
		console.log(Object.values(data))
		second_output3.innerText = (Object.values(data) * num).toFixed(2)

    })
}

backspace3.addEventListener("click", () =>{
    first_output3.innerText.length == 1 ? first_output3.innerText = "0" : first_output3.innerText = first_output3.innerText.slice(0, -1)

    first_option3 = first_select3.options[first_select3.selectedIndex].text.slice(0, 3).toUpperCase()
    second_option3 = second_select3.options[second_select3.selectedIndex].text.slice(0, 3).toUpperCase()
	
	getData(`https://free.currconv.com/api/v7/convert?q=${first_option3}_${second_option3}&compact=ultra&apiKey=3cae6db34f8146f6a410`, first_option3, second_option3, first_output3.innerText)
...
number2.forEach(element =>{
    element.addEventListener("click", (e) =>{
        first_output3.innerText == "0" ? first_output3.innerText = "" : first_output3.innerText = first_output3.innerText
        first_output3.innerText = `${first_output3.innerText}${e.target.innerText}`
        first_option = first_select3.options[first_select3.selectedIndex].text.slice(0, 3).toUpperCase()
        second_option = second_select3.options[second_select3.selectedIndex].text.slice(0, 3).toUpperCase()

		getData(`https://free.currconv.com/api/v7/convert?q=${first_option}_${second_option}&compact=ultra&apiKey=3cae6db34f8146f6a410`, first_option, second_option, first_output3.innerText)
    })
})
